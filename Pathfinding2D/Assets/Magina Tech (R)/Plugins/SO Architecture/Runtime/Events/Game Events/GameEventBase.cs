...
namespace ScriptableObjectArchitecture
{
    public abstract class GameEventBase<T> : GameEventBase, IGameEvent<T>, IStackTraceObject
    {
        ...
        [ShowInInspector] [HideInEditorMode] protected T _runTimeValue = default(T);
        ...
        {
            Raise(Application.isPlaying ? _runTimeValue : _debugValue);
        }
    ...
    public abstract class GameEventBase : SOArchitectureBaseObject, IGameEvent, IStackTraceObject
    {
        ...
        [ShowInInspector] [HideInEditorMode] public List<StackTraceEntry> StackTraces => _stackTraces;
