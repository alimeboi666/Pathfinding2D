...
namespace Magina.Coffee
{
    ...
    public class UIParticleAttractor : MonoBehaviour
    {
        ...
        private int maxAttratingTime;
        [ReadOnly, SerializeField] private int attractingTime;
        ...
        public void SetAttraction(ParticleSystem particleSystem, int time, Action endCallback = null)
        {
            maxAttratingTime = time;
            attractingTime = 0;
        ...
        internal void Attract()
        {
                ...
                if (0f < p.remainingLifetime && Vector3.Distance(p.position, dstPos) < m_DestinationRadius)
                {
                    ...
                    if (m_OnAttracted != null)
                    {
                        try
                        {
                            ...
                            if (++attractingTime >= maxAttratingTime) 
                            {
                                m_ParticleSystem = null;
                                _endCallback?.Invoke();
                                _endCallback = null;
            ...
            if (m_ParticleSystem != null) m_ParticleSystem.SetParticles(particles, count);
        }
